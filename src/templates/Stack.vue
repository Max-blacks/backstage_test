<template>
  <Layout :foot="true" :top="true">
    ...
    <div class="stack-title">
      <h1 class="title">{{ $page.stack.title }}</h1>
      <p class="date">
        {{ dateFormat("YYYY-mm-dd HH:MM:SS", $page.stack.published_at) }}
      </p>
      <div class="author-info-title">
        <g-image class="img1" src="../assets/img/portrait.jpg" />
        <p>{{ $t("author") }}：{{ $page.stack.author }}</p>
      </div>
      <hr class="hr1" />
    </div>
    ...
    <div class="stack-content">
      <div v-html="$show($page.stack.content)" class="content" />
